...
<div id="wrapper">
 ...
 -->                         <li>
                            ...
                            <ul class="nav nav-second-level">
                              <!--   <li>
                                    <a href="forms.html">Technical mail </a>
                                </li> -->
                               <!--  <li>
        	...
        	<div class="Compose-Message">               
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form:input  path="to" class="form-control1 control3" placeholder="enter email"/>
                        <label>Enter Subject :  </label>
                        <form:input  path="subject" class="form-control1 control3" value="Interview schedule"/>
                        <label>Enter Message : </label>
                        <form:textarea rows="6" path="body" class="form-control1 control2"></form:textarea>
                        <hr>
                        <input type="submit" value="Send">
                        <!--  <a href="compose" class="btn btn-warning btn-warng1"><span class="glyphicon glyphicon-envelope tag_02"></span> Send Message </a>&nbsp; -->
